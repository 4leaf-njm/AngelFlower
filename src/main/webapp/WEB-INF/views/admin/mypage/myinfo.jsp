			...
			<form method="post" name="frm_update">
				...
				<div class="form04">
					<div class="row">
						...
						<input type="text" name="company" id="company" class="input02" value="${user.company}"/>
					</div>
					<div class="row">
					...
					<div class="row">
						...
						<input type="text" name="represent" id="represent" class="input02" ${user.represent}>
					</div>
				</div>
				<div class="form01">
					<div class="row">
				...
				<div class="btn_box">
					<a href="javascript:go_updateInfo('admin')">정보 수정</a>
				</div>
			</form>
		</div>
	</div>
