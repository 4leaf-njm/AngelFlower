...
public class PrdController {
	...
	public String modify(@ModelAttribute("m") String m, @RequestParam("no") int prodNo, 
	...
	public String modify(ProductVO product, @RequestParam("mfile") MultipartFile mfile,  Criteria cri, 
		...
		return "redirect:list.do?m=2&page=" + cri.getPage();
	}
